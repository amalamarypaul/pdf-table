# pdf-tablepdf-table helps you to generate PDF documents with table from any NodeJS server. We use [PDF Kit](https://github.com/foliojs/pdfkit) under the hood.## Installation
